...
export default function Profile() {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      >
        ...
        <p className='text-sm self-center'>
          {fileUploadError ? (
            ...
            >Error Image Upload (image must be less thsn 2 mb)
            </span>
        ...
        <button 
        disabled={loading} 
        className='bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-9 disabled:opacity-80'
        >
      ...
      <div className='flex flex-col gap-4 text-customDarkPurple'>
        ...
        <div key={listing._id} className='rounded-lg p-3 flex justify-between items-center gap-4'>
          ...
          <Link className='text-slate-700font-semibold hover:underline truncate flex-1' to={`/listing/${listing._id}`}>
          <p>{listing.name}</p>
          </Link>
